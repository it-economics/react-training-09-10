...
```sh
npx nx serve react-training-2024-09-11--13
```

To create a production bundle:

```sh
npx nx build react-training-2024-09-11--13
```

To see all available targets to run for a project, run:

```sh
npx nx show project react-training-2024-09-11--13
```
